...
def generate_Blog_Content(Title, structure):
    messages = [
    {"role": "system", "content": f"""You are trained to analyze a {Title} and generate a blog post depending on the given {structure}.First analyze the (Language) of {Title} and {structure} and responsed must be in same language.If {Title} and {structure} is (country) specific, Do not follow the country language,Just follow the overall language of {Title}.Response should be in the same language as {Title} and {structure}"""},
    {"role": "user", "content": f"""Analyze the Title and Structure and generate a blog post. The Title is {Title}. The Structure is: {structure}
                                    The Blog post must contain 2000 to 3000 words.Strictly follow the structure given to you.First analyze the (Language) of {Title} and responsed must be in same language.If {Title} and {structure} is (country) specific, Do not follow the country language,Just follow the overall language of {Title}.Response should be in the same language as {Title} and {structure}"""}
    ]
